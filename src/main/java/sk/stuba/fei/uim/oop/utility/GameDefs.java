...
public class GameDefs {
    ...
    public static final float STROKE_PIPE_WALL_RATIO = (float) 0.32;
    public static final float STROKE_PIPE_IN_RATIO = (float) 0.25;
    public static final float STROKE_WATER_RATIO = (float) 0.20;
    public static final float STROKE_HIGHLIGHT_RATIO = (float) 0.20;
